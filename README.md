...
- [ ] Run the complete installed Career OS Profile Builder and market-scan workflows with a real CV, LinkedIn PDF, selected imported provider memories, and company watchlist; validate evidence extraction and review, cross-source canonical resolution, deterministic remote eligibility, compensation confidence, the five-role attention cap, source attribution, and the approval boundary before any application action.
