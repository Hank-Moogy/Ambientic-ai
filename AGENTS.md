# AgentBase repository instructions

- The product name is **AgentBase**. Do not introduce the old product name in UI, documentation, identifiers, or release metadata unless documenting migration history.
...
- Keep AgentBase local-first. Provider credentials stay in each provider's own credential store.
