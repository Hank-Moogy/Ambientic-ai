  ...
  const invoke = async (operation, connection = selected) => {
    ...
    try {
      ...
      if (operation === 'disconnect') {
        if (!window.confirm(`Disconnect ${connection.name}? Active agent sessions using it will lose access.`)) return
